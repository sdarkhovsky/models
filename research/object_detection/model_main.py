...
flags.DEFINE_integer(
    "throttle_secs",
    900,
    "Do not re-evaluate unless the last"
...
flags.DEFINE_boolean(
    "load_pretrained",
    True,
    "If loading pretrained model, otherwise" "initialize weights randomly",
)
flags.DEFINE_float(
    "sparsity",
    None,
    "Desired sparsity to achieve during training. If sparsity"
    "is None then model pruning will not take place",
)
flags.DEFINE_integer("pruning_start_step", None, "Step at which pruning will start")
flags.DEFINE_integer("pruning_end_step", None, "Step at which pruning will stop")
FLAGS = flags.FLAGS
